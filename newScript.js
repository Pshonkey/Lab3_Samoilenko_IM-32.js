...
const n = 10 + n3;
const k = 1.0 - n3 * 0.02 - n4 * 0.005 - 0.25; //k = 0.71
...
const matrixUnOr = adjMatrixUnOrGr(mulmr(randomMatrix, k)); //матриця суміжності неорієнтованого графа
...
const drawOrientedGraph = () => {
    ...
    const interval_id = setInterval(drawVertex, 100);
};
drawOrientedGraph();
